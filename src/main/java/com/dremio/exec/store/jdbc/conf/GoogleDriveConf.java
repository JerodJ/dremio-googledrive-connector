...
@SourceType(value = "GoogleDriveARP", label = "GoogleDrive",uiConfig = "googledrive-layout.json")
public class GoogleDriveConf extends AbstractArpConf<GoogleDriveConf> {
  private static final String ARP_FILENAME = "arp/implementation/googledrive-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googledrive.GoogleDriveDriver";
